...
// Various functions
	...
	/** exponential of this complex number ---added by Connie Chen */
	public Complex exp(){
		return new Complex(Math.cos(re), Math.sin(im));
	}
	
	/** added by Connie Chen */
	public Complex sec(){
		return new Complex(1.0, 0.0).div(cos());
	}
	
	/** added by Connie Chen */
	public Complex csc(){
		return new Complex(1.0, 0.0).div(sin());
	}
	
	/** added by Connie Chen */
	public Complex cot(){
		return new Complex(1.0, 0.0).div(tan());
	}
...
// Inverse trigonometric functions
	...
	/** added by Connie Chen */
	public Complex acot(){
		return new Complex(1.0, 0.0).div(this).atan();
	}
