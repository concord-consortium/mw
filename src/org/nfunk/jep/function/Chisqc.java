...
/**
 * This class computes the area under the right hand tail (from x to infinity) of the Chi square probability density
 * function with v degrees of freedom.
 * 
 * @author Connie Chen
 */

public class Chisqc extends PostfixMathCommand {
	...
	public static double compute(double df, double x) throws ArithmeticException {
		...
		return Igamc.compute(df / 2.0, x / 2.0);
