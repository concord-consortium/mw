...
public class ParseException extends Exception {
	...
	/**
	 * getErrorInfo() was added to the parser generated code to provide clean output instead of the standard format of
	 * Exception.toString(). It returns a short description of the error that occured as well as the position of next
	 * token as part of the string.
	 */
