...
public class SmarterJmolAdapter extends JmolAdapter {
	...
	public Object openBufferedReader(String name, BufferedReader bufferedReader, int[] params) {
		try {
			Object atomSetCollectionOrErrorMessage = Resolver.resolve(name, bufferedReader, logger, params);
			...
			org.myjmol.util.Logger.error(null, e);
			return "" + e;
		}
	}
	...
	public Object openBufferedReader(String name, BufferedReader bufferedReader) {
		try {
			Object atomSetCollectionOrErrorMessage = Resolver.resolve(name, bufferedReader, logger);
			if (atomSetCollectionOrErrorMessage instanceof String)
				return atomSetCollectionOrErrorMessage;
			if (atomSetCollectionOrErrorMessage instanceof AtomSetCollection) {
				AtomSetCollection atomSetCollection = (AtomSetCollection) atomSetCollectionOrErrorMessage;
	...
	public Object openBufferedReaders(String[] name, BufferedReader[] bufferedReader) {
		...
		for (int i = 0; i < size; i++) {
			try {
				Object atomSetCollectionOrErrorMessage = Resolver.resolve(name[i], bufferedReader[i], logger);
				if (atomSetCollectionOrErrorMessage instanceof String)
					return atomSetCollectionOrErrorMessage;
				if (atomSetCollectionOrErrorMessage instanceof AtomSetCollection) {
	...
	/*
	 * XIE public Object openDOMReader(Object DOMNode) { try { Object atomSetCollectionOrErrorMessage =
	 * Resolver.DOMResolve(DOMNode, logger); if (atomSetCollectionOrErrorMessage instanceof String) return
	 * atomSetCollectionOrErrorMessage; if (atomSetCollectionOrErrorMessage instanceof AtomSetCollection) {
	 * AtomSetCollection atomSetCollection = (AtomSetCollection)atomSetCollectionOrErrorMessage; if
	 * (atomSetCollection.errorMessage != null) return atomSetCollection.errorMessage; return atomSetCollection; }
	 * return "unknown DOM reader error"; } catch (Exception e) { Logger.error(null, e); return "" + e; } }
	 */
	...
	/*
	 * // not redefined for the smarterJmolAdapter, but we probably // should do something similar like that. This would
	 * required // us to add a Properties to the Atom, I guess... public String getClientAtomStringProperty(Object
	 * clientAtom, String propertyName) { return null;
	 * 
	...
	class AtomIterator extends JmolAdapter.AtomIterator {
		...
		public int getAtomSite() {
			return atom.atomSite;
		}

		public Object getUniqueID() {
			return new Integer(atom.atomIndex);
		}
		...
		public char getChainID() {
			return canonizeChainID(atom.chainID);
		}
