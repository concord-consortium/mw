...
final class CorruptedDataMessage implements ErrorMessage {

	private Exception exception;
	private Style[] styles;

	public CorruptedDataMessage(Page page) {

		styles = new Style[3];

		styles[0] = page.addStyle(null, null);
		StyleConstants.setIcon(styles[0], new ImageIcon(getClass().getResource("images/CorruptedData.gif")));
	...
	public String[] getStrings() {
		return new String[] {
				...
				"Error URL: " + (exception != null ? exception.getMessage() : "Not specified")
						+ "\n\nThis page contains no data, or data that cannot be displayed." };
	}
