...
final class UnknownHostMessage implements ErrorMessage {

	private Exception exception;
	private Style[] styles;

	public UnknownHostMessage(Page page) {

		styles = new Style[3];

		styles[0] = page.addStyle(null, null);
		StyleConstants.setIcon(styles[0], new ImageIcon(getClass().getResource("images/UnknownHost.gif")));
	...
	public String[] getStrings() {
		return new String[] {
				" ",
				"  Unknown host.\n\n",
				"Error URL: " + (exception != null ? exception.getMessage() : "Not specified") + "\n\nThe "
						+ Page.getSoftwareName()
						+ " cannot connect to the above address. (The IP address of a host could not be determined.)" };
	}
