...
final class PageUnavailableMessage implements ErrorMessage {

	private Exception exception;
	private Style[] styles;

	public PageUnavailableMessage(Page page) {

		styles = new Style[3];

		styles[0] = page.addStyle(null, null);
		StyleConstants.setIcon(styles[0], new ImageIcon(getClass().getResource("images/PageNotFound.gif")));
	...
	public String[] getStrings() {
		return new String[] {
				...
				"Error URL: "
						...
						+ "\n\nThe document you are looking for is unavailable. Please check the directory and file name." };
	}
