...
final class UnsupportedEncodingMessage implements ErrorMessage {

	private Exception exception;
	private Style[] styles;

	public UnsupportedEncodingMessage(Page page) {
	...
	public String[] getStrings() {
		return new String[] {
				" ",
				"  The character encoding of this page is not supported by your operating system.\n\n",
				"Character encoding: "
						+ (exception != null ? exception.getMessage() : "Not specified")
						+ "\n\nThe "
						+ Page.getSoftwareName()
						+ " cannot display this page, because it is written in a language that is not supported by your operating system." };
	}
