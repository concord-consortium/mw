...
public class ParameterChangeEvent extends EventObject {
	...
	public ParameterChangeEvent(Object source) {
		super(source);
	}

	/** construct an event when we do not care about the values before and after changes. */
	public ParameterChangeEvent(Object source, byte type) {
		this(source);
		this.type = type;
	}

	/** construct an event with old and new values */
	public ParameterChangeEvent(Object source, String parameterName, Object oldValue, Object newValue) {
		this(source);
