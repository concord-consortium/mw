...
class HeatBathPanel {
	...
	HeatBathPanel(MDModel model) {

		this.model = model;

		field1 = new RealNumberTextField(model.heatBathActivated() ? model.getHeatBath().getExpectedTemperature()
	...
	JDialog createDialog() {
		...
		String s = MDView.getInternationalText("HeatBathSettings");
		...
		s = MDView.getInternationalText("HeatBathTemperature");
		...
		s = MDView.getInternationalText("HeatBathInterval");
