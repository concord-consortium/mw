...
class MoleculeSelectionPanel extends JPanel {
	...
	MoleculeSelectionPanel(final MolecularView view) {
		...
		comboBox.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					view.setCurrentMoleculeToAdd(comboBox.getSelectedIndex());
				}
			}
		});
		fillComboBox();
		...
		String s = MolecularContainer.getInternationalText("SelectMolecule");
		p.add(new JLabel(s != null ? s : "Select molecule:"));
